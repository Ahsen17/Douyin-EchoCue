...
""".strip(),
        ...
        monkeypatch.setenv("AIGC_LEXICON_GRPC_ENABLED", "true")
        monkeypatch.setenv("AIGC_LEXICON_GRPC_TARGET", "lexicon:50051")
        monkeypatch.setenv("AIGC_LEXICON_GRPC_TIMEOUT", "2.5")
